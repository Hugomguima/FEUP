...
void ver_pacotes(vector<int> v_index)
{
...
int main()
{
	...
	*/
	...
	while (1)
	{
		...
		case('1'):               //Gestão de clientes
		{
			...
			case('1'):          //Adicionar clientes
			{
				...
				cout << "\nIntroduza os pacotes comprados pelo cliente : "; getline(cin, c.pacotes_comprados);
	...
	for (size_t i = 0; i < v_clients.size(); i++)
	{
		...
		fout << v_clients[i].pacotes_comprados << endl;
		fout << "::::::::::" << endl;
	}
	...
	for (size_t i = 0; i < v_packs.size(); i++)
	{
		...
		fout2 << v_packs[i].total_comprados << endl;
		fout2 << "::::::::::" << endl;
	}
